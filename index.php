...
LEFT JOIN categories ON categories.id=posts.category_id ORDER BY posts.id DESC LIMIT $limit OFFSET $offset";
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    <?php
                     ...
                     ?>
                    <a class="btn btn-primary text-uppercase" href="<?=$pageUrl . "?page=".$page-2?>">Previous</a>
                    <?php }?>
                    <a class="btn btn-primary text-uppercase ml-2" href="<?=$pageUrl . "?page=".$page?>">Next</a>
                </div>
            </div>
        </div>
